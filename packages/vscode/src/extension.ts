...
export function activate(context: vscode.ExtensionContext): void {
  ...
  context.subscriptions.push(
    vscode.workspace.onDidOpenTextDocument((d) => check(d, true)),
    vscode.workspace.onDidChangeTextDocument((e) => check(e.document, false)),
    vscode.workspace.onDidSaveTextDocument((d) => check(d, true)),
    ...
    vscode.workspace.onDidCloseTextDocument((d) => {
      const pending = timers.get(d.uri.toString());
      if (pending !== undefined) clearTimeout(pending);
